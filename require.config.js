require.config({
	...
	paths: {
		...
		jqueryEasyUi:'trd/jqueryEasyUi/jquery.easyui.min',

		appConfig:'app.config',
		objFlat:'trd/objFlat/objFlat'
	},
	shim: {
		'ip':{
			deps: ["jqUi","pako","appConfig","objFlat"]
		},
		'uui':{
		...
		'jqueryEasyUi':{
			deps: ["css!trd/jqueryEasyUi/easyui.css","css!trd/jqueryEasyUi/changeStyle.css","jquery"]
		},
		'objFlat':{
			exports:'objFlat'
		}
